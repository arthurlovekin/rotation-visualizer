...
Usage:
    python tests/scipy_test_case_generator.py > tests/rotation_tests_generated.rs
    # or
    python tests/scipy_test_case_generator.py -o tests/rotation_tests_generated.rs
"""
...
//   python tests/scipy_test_case_generator.py -o tests/rotation_tests_generated.rs
//
// To use: copy-paste this entire file to the end of src/app/rotation.rs
// Or add: #[cfg(test)] include!("../../tests/rotation_tests_generated.rs");
